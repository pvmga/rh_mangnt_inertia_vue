...
watch(
    ...
    (val) => {
        if (val) {
            ...
            // Renderiza conteúdo do modal antes de abrir
            showSlot.value = true;

            // Aguarda o próximo tick para garantir que o slot foi renderizado
            nextTick(() => {
            ...
            // Fecha o modal com leve delay para animações
            if (dialog.value?.open) {
                dialog.value.close();
            }

            // Aguarda animação antes de remover conteúdo
            setTimeout(() => {
